...
These are lightweight repo notes, not executable plugins. They exist so Codex has
stable, repo-local entrypoints that complement the skills under `.codex/skills/`.
