...
#
# Usage: bash .claude/skills/preflight/check.sh [path-to-repo-root]
#
...
#   2. .claude/skills/azureAI-optimize/analyze.sh (section 1)
#   3. this file (C1)
...
if [ "$FAILURES" -gt 0 ]; then
  ...
  echo " Remediation guidance: .claude/skills/preflight/SKILL.md"
  exit 1
fi
